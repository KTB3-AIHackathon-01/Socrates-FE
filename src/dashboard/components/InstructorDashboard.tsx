...
export function InstructorDashboard() {
  ...
  return (
    <div className="space-y-6">
      ...
      {selectedStudent && (
        <div className="fixed inset-0 bg-black/50 dark:bg-black/70 flex items-center justify-center z-50 p-4" onClick={() => setSelectedStudent(null)}>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-amber-50 dark:bg-amber-900/20 rounded-xl p-4 border border-amber-200 dark:border-amber-800">
                ...
                <p className="text-sm text-amber-800 dark:text-amber-200">
                  {selectedStudent.name} 학생은 개념 이해가 빠르지만, 심화 문제에서 어려움을 겪고 있습니다. 
                  실전 연습 문제를 더 제공하는 것을 추천합니다.
                </p>
              </div>
            </div>
          </div>
